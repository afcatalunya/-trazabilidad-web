    ...
    <>
      ...
      <div className="flex-1 overflow-auto">
        <div className="p-6 space-y-6 max-w-5xl">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <form onSubmit={crearUsuario} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                >
                  <option value="USUARIO">Usuario (solo lectura / edición básica)</option>
                ...
                <tbody>
                  {usuarios.map(u => (
                    <tr key={u.id} className="border-b border-gray-100 hover:bg-gray-50">
                      ...
                      <td className="py-3">
                        <span className={`px-2 py-1 rounded text-xs font-semibold ${u.rol === 'ADMIN' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-700'}`}>
                          {u.rol}
                        </span>
                      </td>
                      <td className="py-3">
          ...
          {/* ── INFORMES POR EMAIL ────────────────────────────────── */}
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-lg font-bold text-gray-900 mb-1">📧 Informes por Email</h2>
            <p className="text-sm text-gray-500 mb-4">Se envían a danielf@aluminiosfranco.es y juanc@aluminiosfranco.es</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="font-semibold text-gray-800 mb-1">📋 Informe Semanal</h3>
                <p className="text-xs text-gray-500 mb-3">Todos los pedidos activos (no entregados ni anulados). Se envía automáticamente cada lunes a las 8:00.</p>
                <button
                  onClick={() => enviarEmail('semanal', 'Informe semanal')}
                  disabled={emailLoading === 'semanal'}
              ...
              <div className="border border-red-200 rounded-lg p-4 bg-red-50">
                <h3 className="font-semibold text-red-800 mb-1">⚠️ Alerta Terminados Sin Tarragona</h3>
                <p className="text-xs text-red-600 mb-3">Pedidos con material terminado que aún no han llegado al almacén. Se envía automáticamente cada día laborable a las 9:00.</p>
                <button
                  onClick={() => enviarEmail('alerta-terminados', 'Alerta terminados')}
                  disabled={emailLoading === 'alerta-terminados'}
